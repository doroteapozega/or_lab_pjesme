...
// funkcija koja gradi SQL i parametre (ChatGPT pomogao kod svih tih fja za rad s bazom, filtriranjem i exportom)
...
// download csv datoteke (originalne)
app.get("/download/csv", async (req, res) => {
  res.download("pjesme.csv");
});

// download json datoteke (originalne)
app.get("/download/json", async (req, res) => {
  res.download("pjesme.json");
});

app.get("/download/schema", async (req, res) => {
  res.download("schema.json");
});
